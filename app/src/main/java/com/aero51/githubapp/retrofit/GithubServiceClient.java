...
import static com.aero51.githubapp.utils.Constants.BASE_URL;
...
public class GithubServiceClient {
     ...
     *
     * @return The {@link GithubApi} instance
     */
    ...
    /**
     * Method that invokes the {@link GithubApi#searchRepos(String, int, int)} API for
     * retrieving the Repositories using the Search query executed.
     *
     * @param service      The {@link GithubApi} instance for executing the API
     ...
     *                     API Call
     */
    public static void searchRepos(GithubApi service, String query, int page, int itemsPerPage, ApiCallback apiCallback) {
